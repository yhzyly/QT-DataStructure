#include"ComAndEx.h"
void ComAndEx::Compress(string str1,string str2)
{
    string outfilename=ScanCharacter(str1); //扫描源文件种字符的种类及个数，返回源文件的文件名并用string类型变量保存
...
//扫描原文件中字符的种类及频度的函数
string ComAndEx::ScanCharacter(string str)
{
	cout << "请输入要压缩的文件的文件名:";
	string filename;
//	cin >> filename;
...
void ComAndEx::Extract(string str1,string str2)
{
	cout << "请输入您要解压的文件的名字:";
	string filename;
//	cin >> filename;
